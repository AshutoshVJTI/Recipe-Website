...
const Terms = () => {
  return (
    <div className="container mx-auto">
      ...
      <p>
        By posting Content on or through the Website, You represent and warrant
      ...
      <p>
        ...
        display on or through the Website and you are responsible for protecting
        those rights. We take no responsibility and assume no liability for
        Content you or any third party posts on or through the Website. However,
        by posting Content using the Website, you grant us the right and license
        to use, modify, publicly perform, publicly display, reproduce, and
        distribute such Content on and through the Website. You agree that this
        license includes the right for us to make your Content available to
        other users of the Website, who may also use your Content subject to
        these Terms.
      </p>
      <p>
        My Recipe Website has the right but not the obligation to monitor and
